  ...
  return (
    ...
    >
      <div className="relative pt-16 h-full">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 z-10 w-32 h-32 rounded-full overflow-hidden border-5 border-[#F8FAFC] shadow-sm">
          <Image
        ...
        <article className="relative bg-background shadow-sm border rounded-2xl hover:shadow-md transition-all duration-300 pt-20 pb-4 px-4 min-h-49 flex flex-col ">
          <div className="space-y-1 flex-1">
            ...
            <p className="text-sm text-[#727272]">{opportunity.company_name}</p>
          </div>

          <div className="self-end">
            <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#797DE5] text-primary">
